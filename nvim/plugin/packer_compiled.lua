...
_G.packer_plugins = {
  ...
  ["git.nvim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/git.nvim",
  ...
  ["guihua.lua"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/guihua.lua",
  ...
  ["navigator.lua"] = {
    ...
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/navigator.lua",
